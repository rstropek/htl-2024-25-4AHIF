...
public class SelectTests(DataContextFixture fixture) : IClassFixture<DataContextFixture>, IAsyncDisposable
{
    private readonly ApplicationDataContext context = fixture.Context;

    [Fact]
    public async Task BasicSelectCustomers()
    {
        var select = new Select(context);
        var result = (await select.BasicSelectCustomers()).OrderBy(c => c.ID);
    ...
    [Fact]
    public async Task BasicSelectCustomersAnonymous()
    {
        var select = new Select(context);
        var result = await select.BasicSelectCustomersAnonymous();
    ...
    [Fact]
    public async Task BasicSelectOrderHeaders()
    {
        var select = new Select(context);
        var result = (await select.BasicSelectOrderHeaders()).OrderBy(oh => oh.OrderHeaderID);
    ...
    [Fact]
    public async Task SelectWithAggregateCustomerOrderCount()
    {
        var select = new Select(context);
        var result = (await select.SelectWithAggregateCustomerOrderCount()).OrderBy(c => c.ID);
    ...
    [Fact]
    public async Task SelectWithAggregateCustomerTotalRevenue()
    {
        var select = new Select(context);
        var result = await select.SelectWithAggregateCustomerTotalRevenue();
    ...
    [Fact]
    public async Task SelectCustomersWithOrderCountJanuary2024()
    {
        var select = new Select(context);
        var result = (await select.SelectCustomersWithOrderCountJanuary2024()).OrderBy(c => c.ID);
