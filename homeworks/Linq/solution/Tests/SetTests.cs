...
{
    [Fact]
    public void CustomerNotBuyingFeb2024()
    {
        var result = Set.CustomerNotBuyingFeb2024();
    ...
    [Fact]
    public void OrderLinesAboveAverage()
    {
        var result = Set.OrderLinesAboveAverage().OrderBy(ol => ol.ID);
    ...
    [Fact]
    public void RepeatedBuying()
    {
        var result = Set.RepeatedBuying().OrderBy(r => r.CustomerID).ThenBy(r => r.Year1).ThenBy(r => r.Month1).ThenBy(r => r.Year2).ThenBy(r => r.Month2);
